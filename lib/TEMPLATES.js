...
(function() {
  ...
  this.doc_table = function(doc, style) {
    ...
    return render((function(_this) {
      return function() {
        var auto_space_chr, block_space_chr, cells_per_line, free_cell_chr, lines_per_page, x1, xc, y1, yc, _ref, _ref1;
              ...
              for (y = _j = 0; 0 <= y1 ? _j <= y1 : _j >= y1; y = 0 <= y1 ? ++_j : --_j) {
                if (y > 0 && y % lines_per_page === 0) {
                  TR(function() {
                    ...
                    _results = [];
                    for (x = _k = 0, _ref2 = cells_per_line + 1; 0 <= _ref2 ? _k < _ref2 : _k > _ref2; x = 0 <= _ref2 ? ++_k : --_k) {
                      _results.push(TD('.separator'));
                    }
                    return _results;
                  });
                }
