...
(function() {
  ...
  this.create_readstream = function(me) {
    ...
    R.pause();
    this.walk_in_text_order(me, function(error, event) {
  ...
  this.$assemble_html_events = function(settings) {
    ...
    ((至今保藏。))
     */
    var advance, advance_later, advance_now, get_size, is_first_block, is_first_event, justify, me, next_odd_int, par_on_next_chr, sizes, start_size, stop_size;
    ...
    advance_now = (function(_this) {
      return function() {
        if (par_on_next_chr) {
          return _this.advance_column(me);
        }
      };
    })(this);
    ...
    start_size = (function(_this) {
      return function(size) {
        if (size !== '1' && get_size() === '1') {
          justify();
        }
        sizes.push(size);
        return _this.set_size(me, size);
      };
    })(this);
    justify = (function(_this) {
      return function() {
        debug('©6c1', me['ysc'], next_odd_int(me['y']));
        return _this.justify(me, me['ysc'], next_odd_int(me['y']));
      };
    })(this);
    return P1.remit((function(_this) {
