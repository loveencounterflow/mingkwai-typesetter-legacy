...
(function() {
  var Htmlparser, P1, RMY, TEXT, TRM, TS, TYPES, XNCHR, alert, app, badge, cell_idx, chrs, debug, doc, echo, express, help, info, njs_fs, njs_path, rpr, server, urge, verbose, warn, whisper,
  ...
  if (module.parent == null) {
    ...
    app.get("/", function(request, response) {
      ...
      for (idx = _i = 0, _len = _ref.length; _i < _len; idx = ++_i) {
        cell = _ref[idx];
        _ref1 = TS.xy_from_idx(me, idx), x = _ref1[0], y = _ref1[1];
        if (y !== last_y) {
          if (y !== 0) {
            response.write("</tr>\n");
          }
