...
(function() {
  ...
  this._put_auto_space = function(me) {
    var idx;
    idx = me['idx'] += 1;
  ...
  this.advance_chr = function(me) {
    var line_too_short, size, wrong_grid_line;
    ...
    if (size === 1) {
      ...
      me['size'] = 1;
      while (true) {
        line_too_short = (this._get_remaining_line_length(me)) < 1;
        wrong_grid_line = (__modulo(this._get_y(me), size)) !== 0;
        debug('©4r1', line_too_short, wrong_grid_line, me);
        if ((!line_too_short) && (!wrong_grid_line)) {
          break;
        }
        this._put_auto_space(me);
      }
      me['size'] = size;
    }
    return me;
