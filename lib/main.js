...
(function() {
  ...
  this.compress = function(me) {
    var auto_space_chr, blank_count, block_space_chr, cells, cells_per_line, chr_count, d, dx, dy, height, idx, idx0, idx1, size, tmp_cell, tmp_cells, tmp_cells_per_line, tmp_idx, width, x, x0, x1, y, y0, y1, _i, _j, _len, _ref, _ref1, _ref2;
    ...
    for (d = _i = 0; 0 <= blank_count ? _i < blank_count : _i > blank_count; d = 0 <= blank_count ? ++_i : --_i) {
      tmp_cells.push(auto_space_chr);
    }
    for (tmp_idx = _j = 0, _len = tmp_cells.length; _j < _len; tmp_idx = ++_j) {
