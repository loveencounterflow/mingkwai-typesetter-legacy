...
(function() {
  ...
  this.pcr_from_xy = function(me, xy) {
    var cells_per_line, col, direction, layout, lines_per_page, page_idx, row, x, y, _ref;
    ...
    _ref = layout === 'rows' ? [x, y] : [y, x], col = _ref[0], row = _ref[1];
    if (direction === 'rtl') {
      col = cells_per_line - col;
    }
