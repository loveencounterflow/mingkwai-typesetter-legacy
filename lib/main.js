...
(function() {
  ...
  this.walk = function(me, handler) {
    var block_space_chr, cells, cells_per_line, content, content_txt, idx, lines_per_page, size, x, y, _i, _len, _ref;
    cells = me.cells, cells_per_line = me.cells_per_line, lines_per_page = me.lines_per_page, block_space_chr = me.block_space_chr;
    for (idx = _i = 0, _len = cells.length; _i < _len; idx = ++_i) {
      content = cells[idx];
      if (content === block_space_chr) {
        continue;
      }
      if (content === void 0) {
        continue;
